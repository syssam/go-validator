...
var MessageMap = map[string]string{
	...
	"country.alpha2":       "The {{.Attribute}} must be a valid ISO 3166-1 alpha-2 country code.",
	"country.alpha3":       "The {{.Attribute}} must be a valid ISO 3166-1 alpha-3 country code.",
	"country.numeric":      "The {{.Attribute}} must be a valid ISO 3166-1 numeric country code.",
	"currency":             "The {{.Attribute}} must be a valid currency code.",
	"currency.all":         "The {{.Attribute}} must be a valid currency code.",
	"currency.fiat":        "The {{.Attribute}} must be a valid ISO 4217 currency code.",
	"currency.crypto":      "The {{.Attribute}} must be a valid cryptocurrency code.",
	...
	"language.alpha2":      "The {{.Attribute}} must be a valid ISO 639-1 language code.",
	"language.alpha3":      "The {{.Attribute}} must be a valid ISO 639-2 language code.",
	...
	"phone.e164":           "The {{.Attribute}} must be a valid E.164 phone number.",
